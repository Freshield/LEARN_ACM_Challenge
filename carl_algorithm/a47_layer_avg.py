...
@File: a47_layer_avg.py
@Time: 2022-04-20 17:24
@Last_update: 2022-04-20 17:24
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
def layer_avg(root):
    ...
    while len(queue) != 0:
        ...
        rst_list.append(sum / queue_length)
